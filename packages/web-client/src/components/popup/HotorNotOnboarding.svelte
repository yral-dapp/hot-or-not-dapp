	...
	>
		{#if step == 1}
			<div class="flex h-full w-full max-w-md flex-col items-center justify-center space-y-32">
				...
				<div class="relative select-none text-center text-3xl font-bold ">
					...
					A new experience<br />awaits you
				</div>
		...
		{:else if step == 2}
			<div class="flex h-full w-full max-w-md flex-col items-center justify-center space-y-8">
				...
				<button on:click="{() => ($showOnboarding = false)}" class="font-medium"> Skip </button>
		...
		{:else if step == 3}
			<div class="flex h-full w-full max-w-md flex-col items-center justify-center space-y-16">
				<div class="text-3xl font-bold">Place your first bet</div>
