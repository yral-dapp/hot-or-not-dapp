...
import UploadLayout from '$lib/components/layout/UploadLayout.svelte'
import { tweened } from 'svelte/motion'
import { cubicInOut } from 'svelte/easing'
import UploadStep from '$lib/components/upload/UploadStep.svelte'
import { onMount, onDestroy, tick } from 'svelte'
import { fileToUpload } from '$lib/stores/fileUpload'
import { goto } from '$app/navigation'
import { authState } from '$lib/stores/auth'
import type { UploadStatus } from '$lib/components/upload/UploadTypes'
import { checkVideoStatus, uploadVideoToStream } from '$lib/helpers/stream'
import Log from '$lib/utils/Log'
import TagsInput from '$lib/components/tags-input/TagsInput.svelte'
