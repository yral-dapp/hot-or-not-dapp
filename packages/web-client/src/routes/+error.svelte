...
<div
  class="flex h-full w-full flex-col items-center justify-center space-y-8 text-white">
  ...
  <div
    class="flex flex-col items-center rounded-md bg-white/10 p-2 font-mono text-xs">
    <div>
      Code: {status}
    </div>
    <div>
