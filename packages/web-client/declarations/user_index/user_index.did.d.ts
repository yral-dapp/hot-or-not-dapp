...
export type KnownPrincipalType =
	| { CanisterIdUserIndex: null }
...
export type Result = { Ok: null } | { Err: SetUniqueUsernameError };
export type SetUniqueUsernameError =
...
export interface _SERVICE {
	get_canister_status_from_management_canister: ActorMethod<[Principal], CanisterStatusResponse>;
	...
	get_requester_principals_canister_id_create_if_not_exists_and_optionally_allow_referrer: ActorMethod<
		...
		Principal
	>;
	get_user_canister_id_from_unique_user_name: ActorMethod<[string], [] | [Principal]>;
	get_user_canister_id_from_user_principal_id: ActorMethod<[Principal], [] | [Principal]>;
	...
	update_user_index_upgrade_user_canisters_with_latest_wasm: ActorMethod<[], UpgradeStatus>;
	update_user_remove_role: ActorMethod<[UserAccessRole, Principal], undefined>;
}
