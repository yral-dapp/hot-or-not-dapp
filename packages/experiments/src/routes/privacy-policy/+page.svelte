...
<HomeLayout>
  ...
  <svelte:fragment slot="content">
    <div
      class="mt-20 flex h-full w-full flex-col space-y-8 overflow-hidden overflow-y-auto px-8 py-20">
      <div class="text-xs">
          ...
          <ul class="list-decimal pl-6">
            <li>
              ...
              <ul class="list-disc pl-4">
                <li>
                  ...
                  your account using your google account, or otherwise, and we
                  may collect your email address and name. We may also ask you
                  to provide certain information including your content/category
                  preferences, location, areas of interest, language, region
                  preferences etc.
                </li>
                <li>
                  We may ask you for the location information and regional
            ...
            <li>
              ...
              <ul class="list-disc pl-4">
                ...
                <li>
                  Hot or Not may access your device's camera, microphone, photo
      ...
      <div class="flex flex-col space-y-2">
        <div class="text-sm">
          6. Assignment, Change Of Control, And Transfer
        </div>
        <div class="text-xs">
      ...
      <div class="flex flex-col space-y-2">
        ...
        <div class="text-xs">
          You can opt out from our use of data from cookies and similar
      ...
      <div class="flex flex-col space-y-2">
        ...
        <div class="text-xs">
          ...
          <ul class="list-decimal pl-6">
            ...
            <li>
              Usage of Face Data: To make Hot or Not app work well for their
            ...
            <li>
              Disclosure of Face Data: This data is used to create filters and
            ...
            <li>
              Retention of Face Data: We do not store any Facial Recognition
