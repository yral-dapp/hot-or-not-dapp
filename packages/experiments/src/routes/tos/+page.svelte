  ...
  <svelte:fragment slot="content">
    <div
      ...
      <div class="flex flex-col space-y-2">
        ...
        <div class="text-xs">
          Thanks for choosing Hot or Not, an online social platform. This is an
          ...
          in the application. Subject to the foregoing, we are pleased to make
          our services available to you, which include the Hot or Not Web App,
          website, social and interactive features, which include image posting,
          video posting and other associated services ("Services"). These
          images, videos, clips, interactions etc. on Hot or Not posted by the
          users shall be the "Content". If you install, use, access Hot or Not
          or any of its features, you have read and accepted these terms and
          conditions. You have also accepted the Hot or Not [privacy policy
          link], and our [ community guidelines link], and other terms which are
          available on the Hot or Not App, Hot or Not Website, and otherwise.
          Please make sure to read these documents. By using Hot or Not, you are
          entering into a binding contract(s) with us. Your contract with us
          includes the Terms and conditions, privacy policy and community
          guidelines etc. If you don't agree with and accept the above, please
      ...
      <div class="flex flex-col space-y-2">
        ...
        <div class="text-xs">
          ...
          jurisdiction, are permitted to use our Services. You agree that:
          <br />
      ...
      <div class="flex flex-col space-y-2">
        ...
        <div class="text-xs">
          By posting any Content on or through our Services, you hereby grant us
          ...
          <ul class="list-decimal py-2 pl-6">
            ...
            You acknowledge and agree that the Content uploaded is the sole responsibility
      ...
      <div class="flex flex-col space-y-2">
        ...
        <div class="text-xs">
          We may amend or update these Terms. We may update the “Last Modified”
      ...
      <div class="flex flex-col space-y-2">
        ...
        <div class="text-xs">
          You agree to defend, indemnify, and hold harmless us, our parent(s),
      ...
      <div class="flex flex-col space-y-2">
        ...
        <div class="text-xs">
          The Services are provided to you on an 'as is' basis and we do not
